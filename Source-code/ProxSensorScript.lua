   ...
   --------------------------
    ...
    if dist > 0.9 then
        ...
        --    print('leftsensor')
                --turn right
            for i=1,5 do
              sim.setScriptSimulationParameter(rightPropeller , 'particleVelocity' ,-1)
            end
        end
        ...
        if distRight < 0.1 then
            --print('righttsensor')
                --turn left
            for i=1,5 do
               sim.setScriptSimulationParameter(leftPropeller , 'particleVelocity' , -1)
            end
        end
    else
        for i=1,50 do
        ...
        if distLeft < distRight then
            for i=1,3 do
                --turn left
                --print('reverse')
                sim.setScriptSimulationParameter(leftPropeller , 'particleVelocity' , -50)
                sim.setScriptSimulationParameter(rightPropeller , 'particleVelocity' , -50)
            end
            print('go right')
            for i=1,300 do
                --turn right
                sim.setScriptSimulationParameter(leftPropeller , 'particleVelocity' , 150)
                sim.setScriptSimulationParameter(rightPropeller , 'particleVelocity' , -150)
            end
        else
